...
<span style="font-size:1.5em; color=red;">**TL;DR:** <img src="/assets/img/lmcache-logo-small.png" alt="Icon" style="width:150px; vertical-align:middle;"> *turboboosts vLLM with <span style="font-size:1.3em; color=red;">**7×**</span> faster access to <span style="font-size:1.3em; color=red;">**100×**</span> more KV caches.*</span>
