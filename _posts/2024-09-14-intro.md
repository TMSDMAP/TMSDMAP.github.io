---
layout: post
title: "LMCache: Faster, Cheaper LLMs with a CDN of Knowledge"
...
<span style="font-size:1.5em; color=red;">**TL;DR:** *Turboboosting vLLM with <span style="font-size:1.3em; color=red;">**7×**</span> faster access to <span style="font-size:1.3em; color=red;">**100×**</span> more KV caches using <img src="/assets/img/lmcache-logo-small.png" alt="Icon" style="width:150px; vertical-align:middle;">*</span>
...
Meet **LMCache**, a new system developed in UChicago that generates the first token 3-10x faster than vLLM by efficiently managing long documents (and other sources of knowledge) for you.
...
At its core, LMCache uses two techniques.
